    ...
    <div className="flex justify-center overflow-hidden">
      <div className="bg-white rounded-xl p-4 h-[450px] w-full max-w-sm">
        ...
        <div className="flex justify-between items-center mb-3">
          <h3 className="text-[16px] lg:text-[20px] 3xl:text-[22px] font-semibold text-gray-700">Device</h3>
        </div>
        ...
        <div className="mt-4 space-y-2">
          {deviceList.map((item, i) => (
            <div key={i} className="flex items-center justify-between text-[16px] lg:text-[20px] 3xl:text-[22px]">
