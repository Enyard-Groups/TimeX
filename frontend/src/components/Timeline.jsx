  ...
  return (
    <div className="bg-white rounded-3xl p-6 w-full relative overflow-hidden">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex gap-4 text-[10px] xl:text-[13px] font-bold uppercase tracking-wider">
        ...
        >
          <div className="flex border-b border-gray-100 bg-gray-50/95 backdrop-blur-md sticky top-0 z-50">
            {timeLabels.map((time) => (
              <div
                key={time}
                className="flex-none text-[10px] xl:text-[11px] font-extrabold text-gray-400 py-3 border-r border-gray-100 last:border-0"
          ...
          >
            ...
            >
              <div className="bg-indigo-950 text-white text-[9px] xl:text-[11px] font-black px-2 py-0.5 rounded-r-full mt-1 shadow-lg uppercase">
                Now
              </div>
