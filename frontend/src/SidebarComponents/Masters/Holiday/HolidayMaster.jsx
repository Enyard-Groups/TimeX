...
const HolidayMaster = () => {
  ...
  const totalPages = Math.ceil(filteredholidayMaster.length / entriesPerPage);
      ...
      {!openModal && (
        <div className="mt-6 bg-white shadow-xl rounded-xl border border-[oklch(0.8_0.001_106.424)] p-6">
            ...
            <table className="w-full text-lg border-collapse">
              <thead className="bg-[oklch(0.948_0.001_106.424)]">
                <tr>
                  ...
                  <th className="p-2">Holiday_Code</th>
                  <th className="p-2">Holiday_Name</th>
                  <th className="p-2">HolidayStart</th>
                  <th className="p-2">HolidayEnd</th>
          ...
          <div className="flex justify-between items-center mt-4 text-sm">
            <span>
              Showing {Math.min(endIndex, filteredholidayMaster.length)} of{" "}
