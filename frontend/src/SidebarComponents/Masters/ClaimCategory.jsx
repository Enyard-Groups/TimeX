...
const ClaimCategory = () => {
  ...
  const totalPages = Math.ceil(filteredcategory.length / entriesPerPage);
      ...
      {!openModal && (
        <div className="mt-6 bg-white shadow-xl rounded-xl border border-[oklch(0.8_0.001_106.424)] p-6 ">
            ...
            <table className="w-full text-lg border-collapse">
              <thead className="bg-[oklch(0.98_0.02_16.439)]  text-[oklch(0.70_0.246_16.439)]">
                <tr>
                  ...
                  <th className="p-2 font-semibold">Attachment Mandatory</th>
          ...
          <div className="flex justify-between items-center mt-4 text-sm">
            <span>
              Showing {Math.min(endIndex, filteredcategory.length)} of{" "}
          ...
          <div className="bg-white w-full max-w-6xl shadow-xl rounded-xl border border-[oklch(0.923_0.003_48.717)] p-6 relative">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="flex items-center gap-2 mt-6">
                <label className={labelStyle}>Attachment Mandatory</label>
                <input
                  type="checkbox"
                  name="isAttachment"
