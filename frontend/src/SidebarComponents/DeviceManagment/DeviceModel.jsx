      ...
      <div className="bg-gradient-to-br from-white to-slate-50 rounded-2xl overflow-hidden border border-blue-100/50 shadow-xl">
                  ...
                  >
                    ...
                    <td className="px-4 py-3 hidden lg:table-cell text-center">
                      <div className="flex justify-center">
                        <span
                          className={`px-3 py-1 rounded-full text-sm lg:text-base 3xl:text-lg font-semibold border ${item.active ? "bg-green-100 text-green-700 border-green-300" : "bg-gray-100 text-gray-700 border-gray-300"}`}
                        >
        ...
        <div className="p-6 border-t border-blue-100/30 flex flex-col sm:flex-row justify-between items-center gap-6">
          <span className="text-sm lg:text-base 3xl:text-lg text-gray-600">
            ...
            to{" "}
            <span className="text-gray-900 font-semibold">
              {Math.min(endIndex, filtereddeviceModel.length)}
            </span>{" "}
            of{" "}
            <span className="text-gray-900 font-semibold">
              {filtereddeviceModel.length}
            </span>{" "}
            entries
          </span>
          <div className="flex gap-2">
