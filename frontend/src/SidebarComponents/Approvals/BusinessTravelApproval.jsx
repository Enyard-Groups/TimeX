    ...
    <div className="mb-6">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between mb-6 gap-4 pl-10 lg:pl-0">
        <h1 className="flex items-center gap-2 h-[30px] text-lg xl:text-xl font-semibold text-gray-800">
          ...
          <FaAngleRight className="text-blue-500 text-base" />
          <div className="text-blue-600">Business Travel Approval</div>
        </h1>
      </div>
              ...
              {loading ? (
                ...
                currentData.map((item) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-2 text-center hidden xl:table-cell text-gray-600 max-w-xs truncate">
                      {item.purpose || "NIL"}
                    </td>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <span className="px-4 py-2 bg-amber-100 text-amber-700 rounded-lg font-bold text-sm xl:text-base shadow-sm inline-block">
                  {selectedItem.status}
                </span>
              </div>
              ...
              <div className="md:col-span-1">
                ...
                <textarea
                  ...
                  className="w-full bg-white border-2 border-slate-200 px-4 py-2.5 rounded-xl focus:ring-2 focus:ring-rose-400 focus:border-rose-500 transition-all text-sm xl:text-base h-20"
