...
const BusinessTravelApproval = () => {
    ...
    const updateStatus = async (id, value) => {
        ...
        try {
            await axios.put(`${API_BASE}/requests/travel/${id}`, payload);
    ...
    const bulkAction = async (value) => {
        ...
        try {
            await axios.put(`${API_BASE}/requests/travel/bulk`, payload);
                        ...
                        <table className="w-full text-lg border-collapse">
                            <thead className="bg-[oklch(0.94_0.001_106.424)] text-[oklch(0.44_0.001_106.424)]">
                                <tr>
                                    ...
                                    <th className="p-2 hidden lg:table-cell font-semibold text-center">From</th>
                                    <th className="p-2 hidden lg:table-cell font-semibold text-center">To</th>
                                    <th className="p-2 hidden xl:table-cell font-semibold text-center">Reason</th>
                                    <th className="p-2 hidden xl:table-cell font-semibold text-center">Rejected Reason</th>
                            ...
                            <tbody>
                                {loading ? (
                                    <tr><td colSpan="12" className="text-center p-10 font-medium">Loading...</td></tr>
                                ) : filteredData.length === 0 ? (
                                    <tr><td colSpan="12" className="text-center p-10 font-medium text-gray-500">No Pending Requests</td></tr>
                                ) : (
