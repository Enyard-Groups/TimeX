            ...
            <table className="w-full text-lg border-collapse">
              <thead className="bg-[oklch(0.94_0.001_106.424)] text-[oklch(0.44_0.001_106.424)]">
                <tr>
                  ...
                  <th className="p-2 hidden lg:table-cell font-semibold text-center">
                    From
                  </th>
                  <th className="p-2 hidden lg:table-cell font-semibold text-center">
                    To
                  </th>
                  <th className="p-2 hidden xl:table-cell font-semibold text-center">
                    Reason
                  </th>
                  <th className="p-2 hidden xl:table-cell font-semibold text-center">
                    Rejected Reason
              ...
              <tbody>
                {loading ? (
                  <tr>
                    <td colSpan="12" className="text-center p-10 font-medium">
                      Loading...
                    </td>
                  </tr>
