...
const ClaimApproval = () => {
    ...
    const updateStatus = async (id, value) => {
        ...
        const payload = {
            status: value,
            rejectedreason: value === "Rejected" ? (item.rejectedreason || "Rejected") : "-",
        };
                ...
                <div>
                        ...
                        <table className="w-full text-lg border-collapse">
                            <thead className="bg-[oklch(0.94_0.001_106.424)] text-[oklch(0.44_0.001_106.424)]">
                                <tr>
                                    ...
                                    <th className="p-2 font-semibold text-center hidden sm:table-cell">Claim Category</th>
                                    <th className="p-2 font-semibold text-center hidden lg:table-cell">Date</th>
                                    <th className="p-2 font-semibold text-center hidden xl:table-cell">Purpose</th>
                                    <th className="p-2 font-semibold text-center hidden md:table-cell">Amount</th>
                                    <th className="p-2 font-semibold text-center hidden xl:table-cell">Rejected Reason</th>
                                    <th className="p-2 font-semibold text-center">Approve / Reject</th>
                                </tr>
                            </thead>

                            <tbody>
                                {loading ? (
                                    <tr><td colSpan="10" className="text-center p-10 font-medium">Loading...</td></tr>
                                ) : filteredData.length === 0 ? (
                                    <tr><td colSpan="10" className="text-center p-10 font-medium text-gray-500">No Pending Claims</td></tr>
                                ) : (
                                    currentData.map((item) => (
                                        ...
                                        >
                                            ...
                                            <td className="p-2 hidden sm:table-cell">{item.claim_category}</td>
                                            <td className="p-2 hidden lg:table-cell">
                                                {item.date ? new Date(item.date).toLocaleDateString() : "-"}
                                            </td>
                                            <td className="p-2 hidden xl:table-cell">{item.purpose || "NIL"}</td>
                                            <td className="p-2 hidden md:table-cell font-medium">{item.amount}</td>
                    ...
                    <div className="flex justify-center md:justify-between items-center mt-4 text-sm flex-wrap gap-6">
                        ...
                        <div className="flex flex-row space-x-1">
                            ...
                            <div className="p-3 px-4 shadow rounded-full font-medium">{currentPage}</div>
                            <button
