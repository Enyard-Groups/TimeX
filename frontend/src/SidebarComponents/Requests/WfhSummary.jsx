...
import { FaAngleRight, FaE, FaEye } from "react-icons/fa6";
    ...
    <div className="mb-6">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between mb-6 gap-4 pl-10 lg:pl-0">
        <h1 className="flex items-center gap-2 h-[30px] text-lg font-semibold text-gray-800 xl:text-xl">
          ...
          <FaAngleRight className="text-blue-500 text-base" />
          <div className="text-blue-600">WFH Summary</div>
        </h1>
      </div>
        ...
        <div className="p-6 border-b border-blue-100/30">
          <div className="flex flex-col lg:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-wrap gap-3 items-center justify-center">
              <input
                placeholder="Search WFH summary..."
                value={searchTerm}
                onChange={(e) => {
              ...
              {loading ? (
                ...
                currentData.map((item) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-2.5 text-center font-semibold text-blue-600 whitespace-nowrap hidden lg:table-cell">
                      {item.number_of_days}
                    </td>
                    <td className="px-4 py-2.5 text-center text-gray-500 whitespace-nowrap hidden xl:table-cell">
                      {new Date(item.created_at).toLocaleDateString()}
                    </td>
        ...
        >
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                <h3 className={labelStyle}>ID No</h3>
                <p className={inputStyle}>{selectedEntry.idNo}</p>
              </div>
              <div>
                <h3 className={labelStyle}>Employee</h3>
                <p className={inputStyle}>{selectedEntry.employee_name}</p>
              </div>
              <div>
                <h3 className={labelStyle}>From Date</h3>
                <p className={inputStyle}>{selectedEntry.start_date}</p>
              </div>
              <div>
                <h3 className={labelStyle}>To Date</h3>
                <p className={inputStyle}>{selectedEntry.end_date}</p>
              </div>
              <div>
                <h3 className={labelStyle}>Days</h3>
                <p className={inputStyle}>{selectedEntry.number_of_days}</p>
              </div>
              <div>
                <h3 className={labelStyle}>Applied On</h3>
