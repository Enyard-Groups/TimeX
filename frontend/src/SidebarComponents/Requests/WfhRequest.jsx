...
const WfhRequest = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            if (editId) {
                const res = await axios.put(`${API_BASE}/requests/wfh/${editId}`, formData);
                setWfh((prev) =>
    ...
    const totalPages = Math.max(1, Math.ceil(filteredWfh.length / entriesPerPage));

    const handleCopy = () => {
        const header = ["Employee", "From Date", "To Date", "Reason", "Created Date"].join("\t");
    ...
    const handlePDF = () => {
        ...
        const tableColumn = ["Employee", "From Date", "To Date", "Reason", "Created Date"];
            ...
            <div className="mt-6 bg-white shadow-xl rounded-xl border border-[oklch(0.8_0.001_106.424)] p-6">
                    ...
                    <table className="w-full text-lg border-collapse">
                        <thead className="bg-[oklch(0.94_0.001_106.424)] text-[oklch(0.44_0.001_106.424)]">
                            <tr>
                                ...
                                <th className="py-2 px-6 font-semibold hidden lg:table-cell">From Date</th>
                                <th className="py-2 px-6 font-semibold hidden lg:table-cell">To Date</th>
                                <th className="py-2 px-6 font-semibold hidden xl:table-cell">Days</th>
                            ...
                            {currentWfh.length === 0 ? (
                                ...
                                currentWfh.map((item) => (
                                    ...
                                    >
                                        ...
                                        <td className="py-2 px-6 hidden lg:table-cell">{item.start_date}</td>
                                        <td className="py-2 px-6 hidden lg:table-cell">{item.end_date}</td>
                                        <td className="py-2 px-6 hidden xl:table-cell">{item.number_of_days}</td>
                ...
                <div className="flex justify-center md:justify-between items-center mt-4 text-sm flex-wrap gap-6">
                    <span>
                        ...
                        {Math.min(endIndex, filteredWfh.length)} of {filteredWfh.length} entries
                    </span>
                ...
                >
                    <div className="bg-white rounded-xl shadow-xl w-full max-w-6xl p-6 text-[oklch(0.147_0.004_49.25)] overflow-y-auto max-h-[90vh]">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                <label className={labelStyle}>First Date of Absence <span className="text-red-500">*</span></label>
                            ...
                            <div>
                                <label className={labelStyle}>Last Date of Absence <span className="text-red-500">*</span></label>
                                <div className="relative">
                                    <input
                                        name="end_date"
