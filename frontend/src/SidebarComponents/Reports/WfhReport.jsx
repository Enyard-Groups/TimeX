...
const WfhReport = () => {
  ...
  const handleGenerateReport = async () => {
    try {
      ...
      const res = await axios.get(`${API_BASE}/requests/wfh/report`, { params });
  ...
  const filteredReport = wfhReport.filter(
    (x) =>
              ...
              <table className="w-full text-lg border-collapse">
                <thead className="bg-[oklch(0.94_0.001_106.424)] text-[oklch(0.44_0.001_106.424)]">
                  <tr>
                    ...
                    <th className="p-2 font-semibold whitespace-nowrap hidden md:table-cell">From Date</th>
                    <th className="p-2 font-semibold whitespace-nowrap hidden md:table-cell">To Date</th>
                    <th className="p-2 font-semibold whitespace-nowrap hidden lg:table-cell">Reason</th>
                    <th className="p-2 font-semibold whitespace-nowrap hidden md:table-cell">Number Of Days</th>
                  ...
                  {currentData.length === 0 ? (
                    ...
                    currentData.map((item) => (
                      ...
                      >
                        ...
                        <td className="p-2 hidden lg:table-cell">{item.reason}</td>
