              ...
              <table className="w-full text-lg border-collapse">
                <thead className="bg-[oklch(0.94_0.001_106.424)] text-[oklch(0.44_0.001_106.424)]">
                  <tr>
                    ...
                    <th className="p-2 font-semibold whitespace-nowrap  hidden  hidden xl:table-cell">
                      Check in
                    </th>
            ...
            <div className="flex justify-center md:justify-between items-center mt-4 text-sm flex-wrap gap-6">
              <span>
                ...
                {filteredmannualEntrySummary.length === 0
                  ? "0"
                  : startIndex + 1}{" "}
                to {Math.min(endIndex, filteredmannualEntrySummary.length)} of{" "}
                {filteredmannualEntrySummary.length} entries
              </span>
