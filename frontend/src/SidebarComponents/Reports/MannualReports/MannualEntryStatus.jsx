              ...
              <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <div className="flex gap-3">
                  <input
                    ...
                    className="w-full sm:w-48 bg-blue-50 border border-blue-200 text-gray-900 px-4 py-2 lg:text-base placeholder-blue-500 rounded-lg focus:ring-2 focus:outline-none focus:ring-blue-500/60 transition-all"
                  />
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                {[
                  ...
                  <div key={field.label} className="space-y-1">
                    ...
                    {field.isStatus ? (
                      <p
                        className={`w-fit px-3 py-1 rounded-full text-sm xl:text-lg font-semibold border ${field.value === "Approved" ? "bg-green-100 text-green-700 border-green-200" : "bg-yellow-100 text-yellow-700 border-yellow-200"}`}
                      >
                        {field.value}
                      </p>
                    ) : (
                      <p className="bg-white border border-gray-200 p-3 rounded-xl text-gray-800 font-medium lg:text-lg shadow-sm">
                        {field.value}
                      </p>
                    )}
                  </div>
