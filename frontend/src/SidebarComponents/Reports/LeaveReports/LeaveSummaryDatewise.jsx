              ...
              <table className="w-full text-lg border-collapse">
                <thead className="bg-[oklch(0.94_0.001_106.424)] text-[oklch(0.44_0.001_106.424)]">
                  <tr>
                    ...
                    <th className="p-2 font-semibold whitespace-nowrap hidden lg:table-cell">From Date</th>
                    <th className="p-2 font-semibold whitespace-nowrap hidden lg:table-cell">To Date</th>
