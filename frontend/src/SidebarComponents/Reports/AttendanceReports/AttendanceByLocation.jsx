...
const AttendanceByLocation = () => {
  ...
  const handleExcel = () => {
    ...
    XLSX.writeFile(wb, "AttendanceByLocation.xlsx");
  };

  const handlePDF = () => {
    const doc = new jsPDF("landscape");
    doc.text("Attendance By Location", 14, 14);
    autoTable(doc, {
      startY: 20,
    ...
    doc.save("AttendanceByLocation.pdf");
  };
        ...
        {openModal && (
          <div className="mt-6 bg-white shadow-xl rounded-xl border border-[oklch(0.8_0.001_106.424)] p-6 ">
            ...
            <div className="overflow-x-auto min-h-[250px]" style={{ scrollbarWidth: "none" }}>
              <h1 className="text-[oklch(0.577_0.245_27.325)] text-xl mb-4 text-center"> Attendance By Location </h1>
