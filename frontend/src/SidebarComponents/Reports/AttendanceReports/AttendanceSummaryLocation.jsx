        ...
        {!openModal && (
          <div className="bg-gradient-to-br from-white to-slate-50 p-6 rounded-2xl border border-blue-100/50 shadow-xl mb-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div>
                <label className={labelStyle}>Punch Month</label>
                <input
                  type="month"
                  name="punchMonth"
          ...
          <div className="bg-gradient-to-br from-white to-slate-50 rounded-2xl overflow-hidden border border-blue-100/50 shadow-xl animate-in fade-in duration-500">
                        ...
                        <td className="px-4 py-3 text-center">
                          <div className="flex justify-center">
                            <FaEye
                              ...
                              className="text-blue-500 hover:text-blue-700 xl:text-xl 3xl:text-3xl cursor-pointer"
                            />
                          </div>
                        </td>
                      </tr>
            ...
            <div className="p-6 border-t border-blue-100/30 flex flex-col sm:flex-row justify-between items-center gap-6">
              <span className="text-sm xl:text-base text-gray-600">
                ...
                of{" "}
                <span className="font-bold text-gray-900">
                  {filteredattendanceSummaryLocation.length}
                </span>{" "}
                entries
              </span>
...
export default AttendanceSummaryLocation;
