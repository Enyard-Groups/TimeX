        ...
        {openModal && (
          <div className="mt-6 bg-white shadow-xl rounded-xl border border-[oklch(0.8_0.001_106.424)] p-6 ">
              ...
              <table className="w-full text-lg border-collapse">
                ...
                <tbody>
                  {currentattendanceSummary.length === 0 ? (
                    ...
                    currentattendanceSummary.map((item) => (
                      <tr
                        key={item.id}
                      ...
                      >
                        ...
                        <td className="p-2 hidden lg:table-cell">{"hrs"}</td>

                        <td className="p-2 hidden xl:table-cell">{"1"}</td>

                        <td className="p-2 hidden xl:table-cell">{"2"}</td>

                        <td className="p-2 hidden xl:table-cell">{"3"}</td>

                        <td className="p-2 hidden xl:table-cell">{"4"}</td>

                        <td className="p-2 hidden xl:table-cell">{"5"}</td>
                        <td className="p-2 ">
            ...
            <div className="flex justify-center md:justify-between items-center mt-4 text-sm flex-wrap gap-6">
              <span>
                Showing{" "}
                {filteredattendanceSummary.length === 0 ? "0" : startIndex + 1}{" "}
                to {Math.min(endIndex, filteredattendanceSummary.length)} of{" "}
                {filteredattendanceSummary.length} entries
              </span>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4 overflow-y-auto">
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 text-lg">
                ...
                <div>
                  <p className={labelStyle}>{currentDate}</p>
                ...
                <div>
                  <p className={labelStyle}>Week1Total</p>
                  <p className={inputStyle}>{"1"}</p>
                </div>

                <div>
                  <p className={labelStyle}>Week2Total</p>
                  <p className={inputStyle}>{"2"}</p>
                </div>

                <div>
                  <p className={labelStyle}>Week3Total</p>
                  <p className={inputStyle}>{"3"}</p>
                </div>

                <div>
                  <p className={labelStyle}>Week4Total</p>
                  <p className={inputStyle}>{"4"}</p>
                </div>

                <div>
                  <p className={labelStyle}>Week5Total</p>
